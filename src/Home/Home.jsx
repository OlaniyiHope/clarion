...
Our operations strictly follow DPR and international safety regulations, using certified materials, automated monitoring systems, and rigorous inspection processes to protect lives, property, and the environment.				</p>
		...
		<div class="awaiken-portfolio-grid-item__wrapper">
			...
			<div class="awaiken-portfolio-grid-item__img">
				<img loading="lazy" decoding="async" width="1200" height="800" src={twentys} class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />			</div>
		</a>
		...
		<div class="awaiken-portfolio-grid-item__wrapper">
			...
			<div class="awaiken-portfolio-grid-item__img">
				<img loading="lazy" decoding="async" width="1200" height="800" src={six} class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />			</div>
		</a>
				<div class="awaiken-portfolio-grid-item__content">
				<div class="awaiken-portfolio-grid-title__wrap">
			<a class="awaiken-portfolio-grid-item__link" href="projects/bayside-residences/index.html">
		...
		<div class="awaiken-portfolio-grid-item__wrapper">
			...
			<div class="awaiken-portfolio-grid-item__img">
				<img loading="lazy" decoding="async" width="1200" height="800" src={seven} class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />			</div>
		</a>
				<div class="awaiken-portfolio-grid-item__content">
				<div class="awaiken-portfolio-grid-title__wrap">
			<a class="awaiken-portfolio-grid-item__link" href="projects/parkview-plaza/index.html">
